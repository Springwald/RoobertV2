...
class DRV8830:
    ...
    def motorWrite(self, state, percentage_speed = 0):
        ...
        fault_strings = None #self.__readFaults()
...
if __name__ == "__main__":
	tester = MiniMotorDriver(0x60,0x62)
	while(True):
		tester.stopLeftMotor();
		tester.setRightMotor("FORWARD",100);
		time.sleep(.3);
		
		tester.stopRightMotor();
		tester.setLeftMotor("REVERSE",100);
		time.sleep(.3);
		
		tester.stopLeftMotor();
		tester.setRightMotor("REVERSE",100);
		time.sleep(.3);
		
		tester.stopRightMotor();
		tester.setLeftMotor("FORWARD",100);
		time.sleep(.3);
		...
		#tester.setRightMotor("REVERSE",0);
		#tester.setLeftMotor("FORWARD",0);
		#tester.stopMotors();
		#time.sleep(1.3);
